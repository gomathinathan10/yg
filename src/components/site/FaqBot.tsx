  ...
  return (
    <>
      <button
        ...
        className="floating-faq-btn fixed z-50 flex h-11 w-11 sm:h-12 sm:w-auto items-center justify-center sm:gap-2 rounded-full bg-[#FF9933] hover:bg-[#F0B800] p-0 sm:px-4 text-xs sm:text-sm font-bold text-[#181206] border border-[#D8A700] shadow-lg hover:shadow-xl transition-all hover:scale-105 active:scale-95 cursor-pointer"
      >
      ...
      {open && (
        <div
          ...
          className="fixed inset-x-3 sm:inset-x-auto sm:right-6 sm:w-96 z-50 flex max-h-[72vh] sm:max-h-[70vh] flex-col overflow-hidden rounded-2xl sm:rounded-[8px] border-2 border-[#FF9933] sm:border-[#E8DEC8] bg-white shadow-2xl"
        >
          <header className="bg-[#FF9933] text-[#181206] font-black px-4 py-3 flex items-center justify-between border-b border-[#D8A700]">
            <div>
          ...
          <div ref={listRef} className="flex-1 space-y-4 overflow-y-auto px-4 py-4 bg-[#FAF3D6]">
            {messages.map((m) => (
              <div key={m.id}>
                {m.from === "user" ? (
                  <p className="ml-auto w-fit max-w-[85%] rounded-[6px] bg-[#FF9933] px-3.5 py-2 text-xs text-[#181206] font-bold shadow-xs border border-[#D8A700]">
                    {m.text}
                  </p>
                ) : (
                    ...
                    {m.escalate && (
                      <div className="mt-3 rounded-[4px] border border-[#FF9933]/20 bg-[#FAF3D6] p-2.5 text-[11px]">
                        ...
                        <Button
                          asChild
                          size="sm"
                          className="mt-2.5 w-full h-8 text-[11px] rounded-[4px] bg-[#FF9933] hover:bg-[#E6B000] text-[#181206] font-black font-bold"
                          onClick={() => setOpen(false)}
                        >
          ...
          >
            <input
              ...
              className="min-h-9 flex-1 rounded-[6px] border border-[#E8DEC8] bg-white px-3 text-xs text-[#181206] outline-none focus-visible:border-[#FF9933]"
            />
            <Button
              type="submit"
              size="icon"
              className="h-9 w-9 shrink-0 rounded-[6px] bg-[#FF9933] hover:bg-[#E6B000] text-[#181206] font-black cursor-pointer"
              aria-label="Send"
            >
