//#region node_modules/.nitro/vite/services/ssr/assets/faq-D0byNXr0.js
/**
...
var faqs = [
	...
	},
	{
		...
		answer: "About a quarter teaspoon of powder into hot ghee at the tempering stage serves a family pot of sambar or rasam. For granules, crush a pinch. For the cake, scrape a pea-sized piece. Hing is strong — less is more."
	},
	{
		id: "ingredients",
		keywords: [
		...
		answer: "Compounded asafoetida is resin blended with edible starch and edible gum — that's what makes it pourable and safe to use by the pinch. No artificial colours or preservatives are added."
	},
	{
		id: "shelf-life",
		keywords: [
		...
		answer: "Keep the jar tightly closed in a cool, dry cupboard away from steam. All products have an optimal shelf life of 12 months from packing. Store in an airtight container."
	},
	{
		id: "order-track",
		keywords: [
