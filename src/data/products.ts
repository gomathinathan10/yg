...
export const products: Product[] = [
  {
    ...
    variants: [
      { id: "10g", label: "10 g Cover (Pack of 10)", price: 18, mrp: 20, stock: 150 },
      { id: "20g", label: "20 g Cover (Pack of 10)", price: 36, mrp: 40, stock: 150 },
      { id: "50g", label: "50 g Tray", price: 85, mrp: 96, stock: 120 },
      { id: "100g", label: "100 g Tray", price: 165, mrp: 186, stock: 140 },
      { id: "200g", label: "200 g Container", price: 315, mrp: 350, stock: 80 },
      { id: "500g", label: "500 g Pouch", price: 765, mrp: 850, stock: 60 },
      { id: "1kg", label: "1 kg Pouch", price: 1440, mrp: 1600, stock: 45 },
    ],
    inStock: true,
    rating: 4.8,
    reviews: 312,
  ...
  },
  {
    ...
    variants: [
      { id: "25g", label: "25 g Cake Bag", price: 42, mrp: 46, stock: 80 },
      { id: "50g", label: "50 g Cake Bag", price: 78, mrp: 86, stock: 90 },
      { id: "100g", label: "100 g Cake Bag", price: 148, mrp: 164, stock: 110 },
    ],
    inStock: true,
    rating: 4.7,
    reviews: 142,
